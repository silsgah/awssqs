...
public class CustomerService : ICustomerService
{
    ...
    private readonly ISqsMessenger _qsMessenger;
    ...
    public async Task<bool> CreateAsync(Customer customer)
    {
        ...
        if (response)
        {
            await _qsMessenger.SendMessageAsync(customer.ToCustomerCreatedMessage());
        }
        return response;
    }
    ...
    public async Task<bool> UpdateAsync(Customer customer)
    {
       ...
       if (response)
       {
            await _qsMessenger.SendMessageAsync(customer.ToCustomerUpdatedMessage());
       }
        return response;
    }
    ...
    public async Task<bool> DeleteAsync(Guid id)
    {
        ...
        if (response)
        {
            await _qsMessenger.SendMessageAsync(new CustomerDeleted
            {
                Id = id
            });
        }
